        ...
        public void GCodeGenBtn_Click(object sender, EventArgs e)       //Button zum GCode generieren 
        {
            try
            {
                ...
                if (depth < zkoo1)
                {
                    ...
                    //MessageBox.Show("Ihre Eingaben, waren korrekt, Ihr G-Code wird nun generiert, dies kˆnnte einige Zeit in Anspruch nehmen!");
                    ...
                    if (pB_DragDrop.Image != null)
                    {
                        ...
                        Image save = Image.FromFile("draw" + name);//keine schˆne methode (f¸rs konvertieren) habe aber nichts auf die schnelle gefunden werde das nachtr‰glich machen                
                        ...
                        MessageBox.Show("SIe m¸ssen ein Bild eingeben, bitte per drag and drop in das mittlere Feld");
                }
                else
